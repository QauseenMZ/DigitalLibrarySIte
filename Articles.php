...
<?php 
	include 'dbConnection_Articles.php';
?>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Digital Library Site - Articles</title>
<style type="text/css">
.banner1 {
...
<img src="Images/headerBanner.png" alt="HeaderBanner" width="1225" height="147"/>
...
font-family:'Arial Black', Gadget, sans-serif;
	...
	text-align:center;"/></form>
        ...
        <li> <a href="index.php">All</a></li>
  		...
  		<li> <a href="Articles.php" id="onlink">Articles</a></li>
...
<div id="formWrap">
<div id="form"><form method="POST" action="Articles.php">
		<div class="row">
