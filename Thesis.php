...
<?php 
	include 'dbConnection_Thesis.php';
?>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Digital Library Site - Thesis</title>
<style type="text/css">
...
font-family:'Arial Black', Gadget, sans-serif;
	...
	text-align:center;"/></form>
        ...
        <li> <a href="index.php">All</a></li>
  		...
  		<li> <a href="Thesis.php" id="onlink">Thesis</a></li>
  		</ul>
		</div>
  </div>
...
<div id="formWrap">
<div id="form"><form method="POST" action="Thesis.php">
		<div class="row">
